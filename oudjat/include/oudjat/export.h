...
#define OUDJAT_NO_API NO_EXPORT_ATTRIBUTE

#define OUDJAT_DEPRECATED DEPRECATED_ATTRIBUTE

#define OUDJAT_DEPRECATED_API OUDJAT_DEPRECATED OUDJAT_API

#define OUDJAT_DEPRECATED_NO_API OUDJAT_DEPRECATED OUDJAT_NO_API
